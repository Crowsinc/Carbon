...
namespace cbn
{
	...
	SRes<Texture> Texture::Create(const SRes<Image>& image, const TextureProperties& properties)
	{
	...
	SRes<Texture> Texture::Open(const std::filesystem::path& path, const TextureProperties& properties)
	{
	...
	Texture::Texture(const SRes<Image>& image, const TextureProperties& properties)
	{
		// Create the texture
	...
	void Texture::set_properties(const TextureProperties& properties)
	{
	...
	TextureProperties Texture::get_properties() const
	{
		return m_Properties;
	}
	...
	constexpr TextureUVMap Texture::uvs() const
	{
